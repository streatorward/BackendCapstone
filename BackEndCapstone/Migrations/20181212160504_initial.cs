    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmployeeTicketId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    EmployeeId = table.Column<int>(nullable: false),
                    TicketId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeTickets", x => x.EmployeeTicketId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "DepartmentId", "ApplicationUserId", "Name" },
                values: new object[,]
                {
                    { 1, null, "Shoes" },
                    { 2, null, "Gear" },
                    { 3, null, "Men's Apparel" },
                    { 4, null, "Women's Apparel" },
                    { 5, null, "POS" }
                });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "EmployeeId", "ApplicationUserId", "FirstName", "LastName", "PhoneNumber" },
                values: new object[,]
                {
                    { 1, null, "Tommy", "Allen", "615-123-4567" },
                    { 2, null, "Zack", "Huntington", "615-765-4321" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "EmployeeTicketId", "EmployeeId", "TicketId" },
